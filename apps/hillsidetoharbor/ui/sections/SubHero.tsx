...
const SubHero: FC = () => {
  return (
    <div className='relative isolate overflow-visible bg-white'>
      <div className='flow-root pb-16 pt-2 sm:pt-[5rem]'>
        <div className='mx-auto my-0 px-[2rem] align-top sm:max-w-[85rem] sm:px-[2.5rem] lg:pb-[5rem]'>
          <div className='font-basis-grotesque-pro relative mx-auto grid max-w-md grid-cols-1 gap-x-[1.25rem] gap-y-8 lg:mx-0 lg:my-0 lg:-mb-14 lg:max-w-full lg:grid-cols-3 '>
            <div className='relative my-0'>
              ...
              <h3 className='text-h2hDarkGreen mt-[1rem] text-[2rem] font-bold leading-[100%] tracking-[-0.06em] lg:mt-[1rem]'>
                We pay cash
              </h3>
              <span className='text-[5vw] font-normal leading-tight tracking-[-0.06em] text-[#313A2E] sm:text-[1.3125rem] sm:leading-[140%] lg:mt-[0.75rem] '>
            ...
            <div className='relative z-[100] my-0'>
              <div className='rounded-[2.1875rem] bg-[#ECF0F4] p-8 lg:pt-12 xl:p-10 xl:pt-14'>
                <div className='mx-auto flow-root'>
                  <House className='mx-auto h-fit w-[8rem] py-6 sm:w-[12.68rem] sm:py-0' />
                </div>
              </div>
              <h3 className='text-h2hDarkGreen mt-[1rem] text-[2rem] font-bold leading-[100%] tracking-[-0.06em] lg:mt-[1rem]'>
                We close fast
            ...
            <div className='relative my-0'>
              <div className='rounded-[2rem] bg-[#EEEFE6] p-4 xl:px-10'>
                <div className='mx-auto flow-root'>
                  <PuzzlePiece className='mx-auto h-fit w-[8rem] py-6 sm:w-[10.639375rem] sm:py-0' />
                </div>
              </div>
              <h3 className='text-h2hDarkGreen mt-[1rem] text-[2rem] font-bold leading-[100%] tracking-[-0.06em] lg:mt-[1rem]'>
                We solve problems
