...
/**
 *     <div className='flow-root relative isolate flex-row  bg-[#FDFBF8]/30 px-[4.1666vw] py-[4.1666vw]'>
      <div className='relative flex-col justify-center align-top'>
        <div className='absolute inset-0 bg-center [mask-image:linear-gradient(180deg,rgba(249,242,232,1),rgba(249,242,232,1))]'></div>
        <div className='relative bg-[rgba(249,242,232,1)] px-[4.895%] shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-[88.88888vw] sm:rounded-[3.5rem] max-h-[792px] '>
          <div className='container mx-auto flex w-full object-contain min-w-full max-w-[160rem] flex-row justify-between gap-x-[13.045375%] selection:text-[#F49A7A]'>
            <div className='my-0 mb-[7.77777777777778vw] ml-[4.93055555555556vw] mt-[8.6111111111111vw] w-[48.5833vw] align-top'>
              <h2 className='align-top font-sans text-[5.55555555555556vw] text-black font-medium leading-[5.55555555555556vw] tracking-[-0.06em]'>
                Let us know how we can help
              </h2>
            </div>
            <div className='mb-[5.20833333333333vw] mr-[4.861111vw] mt-[5.9722vw] inline-flex max-w-[16.319vw]'>
              <svg
                viewBox='0 0 235 235'
                fill='none'
                xmlns='http://www.w3.org/2000/svg'
